...
<?
        ...
        if (isset($_POST['restart_pulsemesh'])) {
            $command = 'sudo /home/fpp/media/plugins/fpp-PulseMesh/scripts/restart_pulsemesh.sh';
            $output = [];
            $return_var = 0;
            ...
            if ($return_var === 0) {
                ...
                echo '<div style="background-color: #f8d7da; border: 1px solid #f5c6cb; color: #721c24; padding: 10px; margin: 10px 0; border-radius: 4px;">Error restarting PulseMesh. Please check permissions and script path.</div>';
            }
        }
